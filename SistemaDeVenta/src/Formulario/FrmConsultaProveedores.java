...
public class FrmConsultaProveedores extends JInternalFrame {
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmConsultaProveedores frame = new FrmConsultaProveedores();
	...
	public FrmConsultaProveedores() {
		...
		button_1.setIcon(new ImageIcon(FrmConsultaProveedores.class.getResource("/Recursos/273065992.png")));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////FIN		
		...
		JLabel label_1 = new JLabel("Listado de Proveedores");
		...
		panel.add(label_2);
		label_2.setIcon(new ImageIcon(FrmConsultaProveedores.class.getResource("/Recursos/1967D602A.png")));
		...
		button.setIcon(new ImageIcon(FrmConsultaProveedores.class.getResource("/Recursos/B7D02FDEF.png")));
		...
		btnSalir.setIcon(new ImageIcon(FrmConsultaProveedores.class.getResource("/Recursos/29C5898C8.png")));
		...
		button_3.setIcon(new ImageIcon(FrmConsultaProveedores.class.getResource("/Recursos/AE9D39F1E.png")));
