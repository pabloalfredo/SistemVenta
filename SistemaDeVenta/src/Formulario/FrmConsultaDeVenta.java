...
public class FrmConsultaDeVenta extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmConsultaDeVenta frame = new FrmConsultaDeVenta();
	 ...
	 * Create the frame.
	 */
	public FrmConsultaDeVenta() {
		setBorder(new MatteBorder(3, 3, 3, 3, (Color) new Color(0, 128, 128)));
		setClosable(true);
		setForeground(new Color(0, 0, 128));
		setFont(new Font("SansSerif", Font.BOLD, 18));
		setTitle("Consulta de Venta");
		setFrameIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/B86765EE0.png")));
		...
		lblSubtotal.setBounds(33, 490, 88, 40);
		...
		textField_1.setBounds(123, 493, 138, 28);
		...
		textField_2.setBounds(384, 493, 138, 28);
		...
		lblDescuento.setBounds(273, 496, 107, 28);
		...
		textField_3.setBounds(123, 522, 138, 28);
		...
		label_7.setBounds(734, 224, 49, 17);
		...
		label_8.setBounds(732, 272, 49, 17);
		...
		label_9.setBounds(740, 238, 106, 28);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"<html><h4 font color = blue>Codigo</h3></html>", "<html><h4 font color = blue>Decripcion</h3></html>", "<html><h4 font color = blue>Cantidad</h3></html>", "<html><h4 font color = blue>Precio</h3></html>", "<html><h4 font color = blue>Unidad</h3></html>", "<html><h4 font color = blue>Descuento</h3></html>", "<html><h4 font color = blue>Total</h3></html>"
			}
		) {
		...
		label_11.setBounds(23, 207, 60, 28);
		...
		label_12.setBounds(23, 237, 60, 28);
		...
		label_13.setBounds(4, 267, 79, 28);
		...
		textField_6.setBounds(89, 208, 122, 28);
		...
		textField_7.setBounds(89, 238, 283, 28);
		...
		textField_8.setBounds(89, 268, 283, 28);
		getContentPane().add(textField_8);
		
		JButton btnf_1 = new JButton("Buscar [F4]");
		btnf_1.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/E937E1E0B.png")));
		...
		table_1.setModel(new DefaultTableModel(
			...
			new String[] {
				"Nro Factura", "Fecha", "Hora", "Nombre-Cliente", "Codigo-Cliente", "Total", "Usuario"
			}
		));
		...
		btnSalir.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/salir.png")));
		...
		btnBuscarf.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/E937E1E0B.png")));
		...
		textField.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent arg0) {
				 ...
				 validar.AdmitirSoloNumeros(textField);                         // se pasa por parametro el texfield
			}
		});
		...
		btnImprimir.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/impfv.png")));
		...
		btnAnular.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/abort.png")));
		...
		btnBorrar.setIcon(new ImageIcon(FrmConsultaDeVenta.class.getResource("/Recursos/eliminar.png")));
