...
//////////////////////////////////////////////////////////////////////////////////////////////////////////FIN	
		...
		try {
			modeloTabla = new ModeloTabla("codigoProveedor as 'Codigo del Proveedor' , nombres as Nombres , apellidos as Apellidos , fechaNacimiento as 'Fecha de Nacimiento',sexo as Sexo, estadoCivil as 'Estado Civil', cedula as Cedula, descripcion as Ciudad, direccion as Direccion, email as 'Correo Electronico', celular as Celular, ocupacion as Ocupacion  ", "tblproveedor, tblciudades", "tblproveedor.idCiudad = tblciudades.idCiudad");
