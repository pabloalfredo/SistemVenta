...
public class ClassRegistrarProveedor {
	...
	public ClassRegistrarProveedor(int codigoProveedor, String nombres,
	...
	public ClassRegistrarProveedor (int codigoProveedor, String nombres, String ciudad)
	{
		setCodigoProveedor(codigoProveedor);
		setNombres(nombres);
		setCiudad(ciudad);
	...
	public void registrarNuevoProveedor() throws ClassNotFoundException, SQLException {
		...
		instrucion.setInt(1, getCodigoProveedor());
	...
	public void actualizarProveedor() throws ClassNotFoundException, SQLException{
		...
		instrucion.setInt(12, getCodigoProveedor());
		instrucion.execute();
